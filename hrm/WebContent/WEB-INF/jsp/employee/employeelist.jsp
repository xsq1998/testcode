 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			  ...
 			  $.ligerDialog.confirm("确认要删除吗?","删除",function(r){
		 		...
		 		$("#empform").submit();
		 		  	$.post("employeedel.action",function(data){
						if(data==1){
							alert("删除成功！");
						}else{
							alert("暂无权限！");
...
<body>
	...
	<form name="empform" method="post" id="empform"
		action="${ctx}/employeelist.action">
							...
							<td class="fftd">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										</select>&nbsp; <input type="submit" value="搜索" id="query" /> <input
			...
			<tr valign="top">
				<td height="20">
					<table width="100%" border="1" cellpadding="5" cellspacing="0"
						...
						<c:forEach items="${pageModel.list}" var="employee"
							varStatus="stat">
							<tr id="data_${stat.index}" class="main_trbg" align="center">
								<td><input type="checkbox" id="box_${stat.index}"
									value="${employee.id}" value="employees"></td>
								<td>${employee.name }</td>
								<td><c:choose>
								...
								<td align="center" width="40px;"><a
									href="${ctx}/updateEmployee.action?flag=1&id=${employee.id}">
