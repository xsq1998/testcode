				...
				$.ajax("${ctx}/getcardid.action",// 发送请求的URL字符串。
					{
					   ...
					   success :function(data){
						   if(data)
						   {
							   $("#cardmsgid").html("<span style='color:red;'>身份证号已存在!</span>");
						   }else
						   {
							   $("#cardmsgid").html('');
						   }
...
/* 			$("#cardId").keydown(function(){
				...
				$.post("getcardid.action",{"cardId":cardId},function(data){
					$("#cardmsgid").html("<span style='color:red;'>123</span>");
					if(data==cardId){
						$("#cardmsgid").html("<span style='color:#F00'>身份证号已存在！</span>");
					}else{
						$("#cardmsgid").html("<span style='color:green'>身份证号可使用</span>");
					}
				})
			}) */
		    ...
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td width="200px" id="cardmsgid" name="cardmsgid">&nbsp;</td>
