...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btn").click(function() {
			...
			var ext = file.substring(start,
					file.length).toUpperCase();
			if (ext != ".JPEG" && ext != ".PNG"
					&& ext != ".GIF" && ext != ".BMP"
					&& ext != ".JPG") {
				alert("文档格式仅限jpeg,png,gif,bmp,jpg格式！请重新上传。");
				return false;
			}
...
<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理  &gt; 文档修改
</td>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx}/updateDocument.action?id=${document.id}&flag=2" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
