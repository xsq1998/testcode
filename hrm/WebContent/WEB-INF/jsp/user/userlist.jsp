...
<body>
	...
	<form name="userform" method="post" id="userform"
		...
		<input type="hidden" name="pageIndex" value="${pageModel.pageIndex}"
			id="pageIndex"> <input type="hidden" name="getStatus"
			value="${user_session.status }">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">登录名：<input type="text" name="loginname"
											...
											<input type="button" value="查询" id="query" /><input
						...
						<c:forEach items="${pageModel.list}" var="user" varStatus="stat">
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/viewUser.action?id=${user.id}&flag=1"> <img
