...
<form action="${ctx}/saveOrUpdate.action?id=${dept.id}" id="deptForm" method="post">
  ...
  <tr valign="top">
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="submit" value="${type.id eq null ? '添加':'修改' }">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
	</td>
  </tr>
</table>
